    ...
    <div class="container">
		...
		<form method="POST" action="editar_salvar.php" class="marginB20px">
			<div class="form-group">
				...
				<div>
					<input class="form-control" type="text" placeholder="Nome" value="Nome" name="nome" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div>
					<input class="form-control" type="text" placeholder="CPF" value="CPF" name="cpf" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div>
					<input class="form-control" type="text" placeholder="Endereço"value="Endereço" name="endereco" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div>
					<input class="form-control" type="text" placeholder="Cidade" value="Cidade" name="cidade" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div>
					<input class="form-control" type="text" placeholder="Telefone" value="Telefone" name="telefone" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div>
					<input class="form-control" type="email" placeholder="E-mail" value="E-mail" name="email" required>
				</div>
			</div>
